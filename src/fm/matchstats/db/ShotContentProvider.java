...
public class ShotContentProvider extends BaseProvider {
	...
	static {
		...
		uriMatcher.addURI(PROVIDER_NAME, BASE_PATH, SHOTS);
		uriMatcher.addURI(PROVIDER_NAME, BASE_PATH + "/#", SHOTS_ID);
	}
...
//	---Original returns URI - changed to return long
	...
	public Cursor query(Uri uri, String[] projection, String selection,
		...
		String joinQuery = "shots LEFT OUTER JOIN panel ON (shots.playerID=panel._id)";
		sqlBuilder.setTables(joinQuery);
		sqlBuilder.setProjectionMap(mColumnMap);

		if (uriMatcher.match(uri) == SHOTS_ID)
